...
(function () {
    ...
    // Override console.error to suppress CKEditor widget-toolbar-no-items error
    const originalConsoleError = console.error;
    console.error = function () {
        const args = Array.prototype.slice.call(arguments);
        const message = args[0];

        // Check if this is the specific CKEditor error we want to suppress
        if (typeof message === 'string' &&
            message.includes('widget-toolbar-no-items')) {
